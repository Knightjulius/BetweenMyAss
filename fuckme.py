...
def plot_approximated_bc(graph_name, c_list, output_folder):
    ...
    for c in c_list:
        ...
        with open(averaged_file, 'r') as f:
            ...
            top_nodes = sorted(averaged_results.keys())[:30]  # Get top 30 keys
    ...
    plt.xlabel('Top 30 Nodes (Ranked)')
    ...
    # Save the plot
    output_plot_path = os.path.join(output_folder, f'{graph_name}_approximated_bc_plot.png')
